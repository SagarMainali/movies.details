...
export default function Navbar() {
     return (
          ...
          <div className="fixed w-full max-2xl:w-[calc(100%-40px)] z-10 py-3 bg-primary-dark/50 max-w-[1500px]">
               <div className="flex justify-between items-center">
                    ...
                    <div className="rounded-3xl sm:w-[20rem] w-[10rem] overflow-hidden flex items-center">
                         <input type="text" placeholder="Search..." className="sm:w-[87%] h-[40px] bg-slate-300 text-slate-900 font-medium caret-slate-900 outline-0 px-4 placeholder:text-slate-900 placeholder:text-sm"/>
                         <button className="w-[13%] h-[40px] bg-primary-dark/40">
